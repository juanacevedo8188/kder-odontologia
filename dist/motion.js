...
(() => {
 ...
 const groups=['.about-cards article','.services-grid article','.sedes-grid>*','.coverage-grid article','.coverage-check','.steps article','.faq details','.proposalgrid article','.sectionhead','.about>div:last-child'];
 const items=[];
